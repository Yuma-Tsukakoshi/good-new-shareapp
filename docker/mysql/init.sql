...
insert into user_invitations (user_id, invited_at) values 
(1, DATE_SUB(CURRENT_DATE, INTERVAL 1 DAY)),
(2, DATE_SUB(CURRENT_DATE, INTERVAL 2 DAY)),
(3, DATE_SUB(CURRENT_DATE, INTERVAL 3 DAY)),
(4, DATE_SUB(CURRENT_DATE, INTERVAL 4 DAY));
